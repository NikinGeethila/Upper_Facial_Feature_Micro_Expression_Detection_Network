...
def evaluate(segment_train_images, segment_validation_images, segment_train_labels, segment_validation_labels,test_index ):
    ...
    model.add(Convolution3D(32, (3, 3, 15), strides=1, input_shape=(1, sizeH, sizeV, sizeD), padding='Same'))
    model.add(PReLU())
    model.add(Convolution3D(128, (20, 20, 30), strides=1, input_shape=(1, sizeH, sizeV, sizeD), padding='Same'))
    model.add(PReLU())
    model.add(Convolution3D(256, (20, 20, 60), strides=1, input_shape=(1, sizeH, sizeV, sizeD), padding='Same'))
    model.add(PReLU())
